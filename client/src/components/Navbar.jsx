        ...
        <div className="flex items-center gap-6 relative">
            ...
            {showCreditPopup && (
              <div className="absolute -right-12.5 mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded p-5 z-50">
                ...
                <button
                  ...
                  className="w-full cursor-pointer bg-black text-white py-2 rounded-lg text-sm"
                >
                  Buy more credits
                </button>
              </div>
          ...
          <div className="relative">
            <button
              ...
              className="w-9 h-9 bg-black cursor-pointer text-white rounded-full flex items-center justify-center font-semibold"
            >
              {userData ? (
